...
| **Active Unmerged Branch** | `customer-001c-wallet-mvp` (stack: 001A identity → 001B addresses → 001C wallet, off main `20084eb`) — CUSTOMER-001A auth/OTP/profile (DECISION-100/ADR-016), CUSTOMER-001B address book + checkout addresses (DECISION-101/ADR-017), CUSTOMER-001C Wallet MVP read-model hub (DECISION-102/ADR-018). 949 tests green. Stack reviewed together; NOT merged, NOT pushed. Separately, `website-002a-public-site` (WEBSITE-002A, DECISION-099) also awaits review. |
