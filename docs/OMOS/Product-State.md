...
| **Integration Branch (unmerged)** | `integration-001-beta-rc` — unified beta RC: main `20084eb` + WEBSITE-002A(+polish) `fc5b4b9` + CUSTOMER-001A/B/C + RELEASE-001 `ca2313d`. 991 tests green incl. 10 cross-system integration tests; build clean; browser-smoke clean (EN/TH, 375/768/1440). Awaiting CTO review; NOT merged to main, NOT pushed, NOT deployed. All source branches preserved. |
