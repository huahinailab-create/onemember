...
class DevQueueInspectorController extends DevController
{
    ...
    public function index(): View
    {
        ...
        $pendingJobs= DB::table('jobs')->orderBy('created_at')->limit(20)->get();
        ...
        return view('dev.queue-inspector', compact('stats', 'failedJobs', 'pendingJobs', 'queueInfo'));
    }
    ...
    public function restart(): RedirectResponse
    {
        ...
        if (class_exists(\Laravel\Horizon\Horizon::class)) {
            $this->system->runArtisan('horizon:terminate');
        }
