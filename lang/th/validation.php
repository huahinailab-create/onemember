...
return [
    ...
    'missing_unless'       => ':attribute ต้องไม่มีอยู่เว้นแต่ :other จะอยู่ใน :values',
    'missing_with'         => ':attribute ต้องไม่มีอยู่เมื่อมี :values',
    'missing_with_all'     => ':attribute ต้องไม่มีอยู่เมื่อมีทั้ง :values',
    ...
    'present_unless'       => ':attribute ต้องมีอยู่เว้นแต่ :other จะอยู่ใน :values',
    'present_with'         => ':attribute ต้องมีอยู่เมื่อมี :values',
    'present_with_all'     => ':attribute ต้องมีอยู่เมื่อมีทั้ง :values',
