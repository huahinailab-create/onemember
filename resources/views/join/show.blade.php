...
<head>
    ...
    <title>{{ __('launch.landing_welcome', ['merchant' => $merchant->displayName()]) }} – {{ config('app.name') }}</title>
    @vite(['resources/css/app.css'])
</head>
<body class="launch-landing-body">
    <main class="launch-landing">
        <div class="launch-landing-card">
            <div class="launch-landing-brand">{{ $merchant->displayName() }}</div>
            ...
            <p class="launch-landing-privacy">{{ __('launch.landing_privacy', ['merchant' => $merchant->displayName()]) }}</p>
