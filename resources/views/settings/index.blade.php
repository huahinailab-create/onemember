                    ...
                    <div class="row g-0">
                        <div class="col-12">
                            <dl class="row mb-0">
                                ...
                                <dt class="col-sm-4 text-muted fw-normal">Current Subscription</dt>
                                <dd class="col-sm-8">
                                    <span class="badge bg-primary">Professional Trial</span>
                                    @if ($trialDaysRemaining > 0)
                                        <span class="text-muted small ms-2">{{ $trialDaysRemaining }} {{ Str::plural('day', $trialDaysRemaining) }} remaining</span>
                                    @else
                                        <span class="text-muted small ms-2">Trial expired</span>
                                    @endif
                                </dd>

                                <dt class="col-sm-4 text-muted fw-normal">Trial End Date</dt>
                                <dd class="col-sm-8 text-muted">{{ $trialEndsAt->format('d M Y') }}</dd>
